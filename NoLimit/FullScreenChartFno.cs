...
{
    public partial class FullScreenChartFno : Form
    {
        
        public FullScreenChartFno()
        {
            InitializeComponent();
        }

        private void FullScreenChartFno_Load(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection("Data Source=.\\SQLEXPRESS;Initial Catalog=nsefo2020;Integrated Security=true;");
