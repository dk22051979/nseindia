            ...
            try
            {
                ...
                foreach (DataRow dr in dtItem.Rows)
                {
                    ...
                    if (Series == "EQ" && Symbol != "" && DayHigh != "" && DayLow != "" && DayOpen != "" && DayClose != "" && TradeDate != "" && Volume != "")
                    {
                        ...
                        InsertItemQry = "if not exists(select * from sysobjects where name = 'eq" + Symbol.ToLower() + "' and xtype = 'U') CREATE TABLE eq" + Symbol.ToLower() + " (tradedate date, dayhigh decimal(15,2), daylow decimal(15,2), dayopen decimal(15,2), dayclose decimal(15,2), dayprevclose decimal(15,2), volume int);";
                        ...
                        InsertItemQry = "INSERT INTO eq" + Symbol.ToLower() + "  VALUES ('" + yyyy + "-" + mm + "-" + dd + "','" + DayHigh + "','" + DayLow + "','" + DayOpen + "','" + DayClose + "','" + DayPrevClose + "','" + Volume + "'); ";
